...
class BookingsController extends \BaseController {
	...
	public function index()
	{
		...
		return View::make('Bookings.'.$this->device.'.index', compact('bookings'));
	}
	...
	public function create($id)
	{
		...
		// dd($batchDetails);
		return View::make('Bookings.'.$this->device.'.create',compact('batchDetails','institute_id','posted'))->with('success',Lang::get('payments.verify'));
	}
	...
	public function iframe()
	{
		...
		return View::make('Bookings.'.$this->device.'.iframe',compact('action'));
	}
	/**
	...
	public function store()
	{
		...
		return View::make('Bookings.'.$this->device.'.iframe',compact('encrypted_data','access_code'));
...
*/	}
	...
	public function show($id)
	{
		...
		return View::make('Bookings.'.$this->device.'.show', compact('booking'));
	}
	...
	public function edit($id)
	{
		...
		return View::make('Bookings.'.$this->device.'.edit', compact('booking'));
	}
