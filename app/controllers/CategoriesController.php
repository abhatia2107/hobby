...
class CategoriesController extends \BaseController {
	...
	public function index()
	{
		...
		return View::make($this->device.'.Categories.index',compact('categories','tableName','count','adminPanelListing'));
	}
	...
	{
		return View::make($this->device.'.Categories.create');
	}
	...
	public function show($id)
	{
		...
		return View::make($this->device.'.Categories.show',compact('category','categoryDetails'));
	}
	...
	public function edit($id)
	{
		...
		return View::make($this->device.'.Categories.create',compact('categoryDetails'));
	}
