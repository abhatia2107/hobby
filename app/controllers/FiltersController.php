...
class FiltersController extends \BaseController {
	...
	public function search()
	{
		...
		return View::make($this->device.'.Filters.show',compact('age_group','difficulty_level','gender_group','trial','weekdays','batchesForCategoryLocation','localitiesForLocation','subcategoriesForCategory','category_id','location_id'));
	}
