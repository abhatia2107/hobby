...
class InstitutesController extends \BaseController {
	...
	public function index()
	{
		...
		return View::make($this->device.'.Institutes.index',compact('institutes','tableName','count','adminPanelListing'));
	}
	...
	{
		return View::make($this->device.'.Institutes.create');
	}
	...
	public function show($id)
	{
		...
		return View::make($this->device.'.Institutes.show',compact('instituteDetails','institute_id'));
	}
	/**
	...
	public function edit($id)
	{
		...
		$institute_id=$id;
		return View::make($this->device.'.Institutes.create',compact('instituteDetails','institute_id'));
	}
