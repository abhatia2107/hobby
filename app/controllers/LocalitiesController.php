...
class LocalitiesController extends \BaseController {
	...
	public function index()
	{
		...
		return View::make('Localities.'.$this->device.'.index',compact('localities','tableName','count','adminPanelListing'));
	}
	...
	{
		return View::make('Localities.'.$this->device.'.create');
	}
	...
	public function show($id)
	{
		...
		return View::make('Localities.'.$this->device.'.show',compact('localityDetails'));
	}
	...
	{
		$localityDetails=Locality::find($id);
		return View::make('Localities.'.$this->device.'.create',compact('localityDetails'));
	}
