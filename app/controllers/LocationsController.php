...
class LocationsController extends \BaseController {
	...
	public function index()
	{
		...
		return View::make('Locations.'.$this->device.'.index',compact('locations','tableName','count','adminPanelListing'));
	}
	...
	{
		return View::make('Locations.'.$this->device.'.create');
	}
	...
	public function show($id)
	{
		...
		return View::make('Locations.'.$this->device.'.show',compact('location','locationDetails'));
	}
	...
	public function edit($id)
	{
		...
		return View::make('Locations.'.$this->device.'.create',compact('locationDetails'));
	}
