...
class MembershipsController extends \BaseController {
	...
	public function index()
	{
		...
		return View::make('memberships.'.$this->device.'.index', compact('memberships'));
	}
	...
	{
		return View::make('memberships.'.$this->device.'.create');
	}
	...
	public function show($id)
	{
		...
		return View::make('memberships.'.$this->device.'.show', compact('membership'));
	}
	...
	public function edit($id)
	{
		...
		return View::make('memberships.'.$this->device.'.edit', compact('membership'));
	}
