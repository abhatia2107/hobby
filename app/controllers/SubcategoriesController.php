...
class SubcategoriesController extends \BaseController {
	...
	public function index()
	{
		...
		return View::make($this->device.'.Subcategories.index',compact('subcategories','tableName','count','adminPanelListing'));
	}
	...
	{
		return View::make($this->device.'.Subcategories.create');
	}
	...
	public function show($id)
	{
		...
		return View::make($this->device.'.Subcategories.show',compact('subcategoryDetails'));
	}
	...
	{
		$subcategoryDetails=Subcategory::find($id);
		return View::make($this->device.'.Subcategories.create',compact('subcategoryDetails'));
	}
