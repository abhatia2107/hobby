...
class VenuesController extends \BaseController {
	...
	public function index()
	{
		...
		return View::make($this->device.'.Venues.index',compact('institute_id','venues','localities'));
	}
	...
	public function create()
	{
		...
		//For the navbar of vendor panel. It is being used in layout file to show this navbar.
		$institute_id=$this->institute->getInstituteforUser($user_id);
		return View::make($this->device.'.Venues.create',compact('institute_id','localities'));
	}
	...
	public function edit($id)
	{
		...
		return View::make($this->device.'.Venues.create',compact('institute_id','localities','locations','venueDetails'));
	}
