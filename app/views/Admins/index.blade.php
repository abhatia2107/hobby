...
<li class="dropdown">
      ...
      <div class="row">
         <div class="col-lg-12">
            <h1 class="page-header">Main Admin
               <small></small>
            </h1>
         </div>
      </div>
                    ...
                    <td>
                        <div class="bs-example">
	                        <div class="btn-group">
	                           ...
	                           <ul class="dropdown-menu">
	                              <li><a href="/admins/{{$data->id}}"><span class="glyphicon glyphicon-pencil"></span> View</a></li>
	                              <li><a href="#"><span class="glyphicon glyphicon-share"></span> Disable</a></li>
	                              <li><a href="#"><span class="glyphicon glyphicon-print"></span> Print the details</a></li>
	                              <li class="divider"></li>
	                              <li><a href="/admins/delete/{{$data->id}}"><span class="glyphicon glyphicon-trash" onclick="myFunction()"></span> Remove</a></li>
	                           </ul>
	                        </div>
                     	</div>
                    </td>
