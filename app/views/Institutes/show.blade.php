						...
						<div class="col-md-12 col-xs-12 col-sm-12 column">
							<div class="col-md-12 col-xs-12 col-sm-12 column">
								<div class="col-md-8 col-xs-12 col-sm-8 column">
									<span id="batch_name"> <a href="/batches/batchID">{{$data->batch}} </span> </a>
									<br><span class="inst_name">{{$data->institute}}</span>
								</div>
						...
						<div class="col-md-12 col-xs-12 col-sm-12 column" style="margin-top:20px">
							...
							<div class="col-md-3 col-xs-12 col-sm-4 column" id="rating-schedule" style="">
								<div id='rating' style="margin-left:50px;">
									<div class="inscore" style="margin-left:18px;"><div style="margin-top:-4px;" id="rating-value">{{$instituteDetails->institute_rating}}</div></div><br>
									<span style="clear:both;position:relative"class="stars">{{$instituteDetails->institute_rating}}</span>
								</div>
