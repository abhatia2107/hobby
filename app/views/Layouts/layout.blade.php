...
<!--sign-UP pop up modal-->
    ...
    <div id="ajax-response"></div>
      <script>eval(mod_pagespeed_vL28zK69LJ);</script>
      <script type="text/javascript">var _wpcf7={"loaderUrl":"https:\/\/demo.astoundify.com\/listify\/wp-content\/plugins\/contact-form-7\/images\/ajax-loader.gif","sending":"Sending ..."};</script>
      ...
      <script type="text/javascript">var wc_add_to_cart_params={"ajax_url":"\/listify\/wp-admin\/admin-ajax.php","ajax_loader_url":"\/\/demo.astoundify.com\/listify\/wp-content\/plugins\/woocommerce\/assets\/images\/ajax-loader@2x.gif","i18n_view_cart":"View Cart","cart_url":"https:\/\/demo.astoundify.com\/listify\/cart\/","is_cart":"","cart_redirect_after_add":"yes"};var wc_add_to_cart_params={"ajax_url":"\/listify\/wp-admin\/admin-ajax.php","ajax_loader_url":"\/\/demo.astoundify.com\/listify\/wp-content\/plugins\/woocommerce\/assets\/images\/ajax-loader@2x.gif","i18n_view_cart":"View Cart","cart_url":"https:\/\/demo.astoundify.com\/listify\/cart\/","is_cart":"","cart_redirect_after_add":"yes"};</script>
      ...
      <script>eval(mod_pagespeed_E1D1URTX2p);</script>
      <script type="text/javascript">var woocommerce_params={"ajax_url":"\/listify\/wp-admin\/admin-ajax.php","ajax_loader_url":"\/\/demo.astoundify.com\/listify\/wp-content\/plugins\/woocommerce\/assets\/images\/ajax-loader@2x.gif"};var woocommerce_params={"ajax_url":"\/listify\/wp-admin\/admin-ajax.php","ajax_loader_url":"\/\/demo.astoundify.com\/listify\/wp-content\/plugins\/woocommerce\/assets\/images\/ajax-loader@2x.gif"};</script>
      ...
      <script>eval(mod_pagespeed_TG3knWk9QG);</script>
      <script type="text/javascript">var wc_cart_fragments_params={"ajax_url":"\/listify\/wp-admin\/admin-ajax.php","fragment_name":"wc_fragments"};var wc_cart_fragments_params={"ajax_url":"\/listify\/wp-admin\/admin-ajax.php","fragment_name":"wc_fragments"};</script>
      ...
      <script type="text/javascript">var listifySettings={"ajaxurl":"https:\/\/demo.astoundify.com\/listify\/wp-admin\/admin-ajax.php","homeurl":"https:\/\/demo.astoundify.com\/listify\/","archiveurl":"https:\/\/demo.astoundify.com\/listify\/listings\/","is_job_manager_archive":"","l10n":{"closed":"Closed"}};var listifyListingGallery={"canUpload":"","gallery_title":"Add Images to Gallery","gallery_button":"Add to gallery","delete_image":"Delete image","default_title":"Upload","default_button":"Select this"};</script>
      ...
      <script>eval(mod_pagespeed_M3WbNzPRHO);</script>
      <script>Receiptful.setTrackingCookie();</script>
