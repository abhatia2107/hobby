  ...
  <ul>
    <li id="login">
      <a id="login-trigger" href="#">
        Add a Location <span>▼</span>
      </a>
      <div id="login-content">
        <form>
          <fieldset id="inputs">
		<input id="username" type="text" name="location" placeholder="Location Name" required>  
          </fieldset>
          <fieldset id="actions">
                    ...
                    <td>
                     <div class="bs-example">
                        <div class="btn-group">
                           ...
                           <ul class="dropdown-menu">
                              <li><a href="/locations/{{$data->id}}"><span class="glyphicon glyphicon-pencil"></span>View</a></li>
                              <li><a href="/locations/edit/{{$data->id}}"><span class="glyphicon glyphicon-share"></span> Edit</a></li>
                              <li><a href="#"><span class="glyphicon glyphicon-print"></span> Print the details</a></li>
                              <li class="divider"></li>
                              <li><a href="/locations/delete/{{$data->id}}"><span class="glyphicon glyphicon-trash"></span> Remove</a></li>
                           </ul>
                        </div>
                     </div>
                  </td>
