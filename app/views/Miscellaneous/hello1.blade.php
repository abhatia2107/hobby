...
<div style="background-image: url(https://demo.astoundify.com/listify/wp-content/uploads/sites/39/2014/10/main-bg-top_mini-1.jpg);" class="homepage-cover page-cover entry-cover has-image">
               ...
               <div style="width: 750px; " class="wp-video">
                  <div style="position: absolute; top: 0px; left: 0px; bottom: 0px; right: 0px; overflow: hidden; background-size: cover; background-repeat: no-repeat; background-position: center center;">
                     <video style="margin: auto; position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); width: 1290px; height: auto; visibility: visible;" class="wp-video-shortcode" id="video-6-1" loop="1" autoplay="1" preload="auto" controls="controls" height="422" width="750">
                        <source type="video/mp4" src="https://f6ca679df901af69ace6-d3d26a34307edc4f7eeb40d85a64c4a7.ssl.cf5.rackcdn.com/listify-loops-new.mp4?_=1">
                        <source type="video/webm" src="https://f6ca679df901af69ace6-d3d26a34307edc4f7eeb40d85a64c4a7.ssl.cf5.rackcdn.com/listify-loops-new.webm?_=1">
                     </video>
                  </div>
               </div>
