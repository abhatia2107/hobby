  ...
  <ul>
    <li id="login">
      <a id="login-trigger" href="#">
        Add a Sub-Category <span>▼</span>
      </a>
      <div id="login-content">
        <form>
          <fieldset id="inputs">
		<input id="username" type="password" name="User Name" placeholder="Category Name" required>  
<input id="username" type="password" name="User Name" placeholder="Sub-Category Name" required> 
          </fieldset>
          <fieldset id="actions">
                    ...
                    <td>
                     <div class="bs-example">
                        <div class="btn-group">
                           ...
                           <ul class="dropdown-menu">
                              <li><a href="/subcategories/{{$data->id}}"><span class="glyphicon glyphicon-pencil"></span>View</a></li>
                              <li><a href="/subcategories/edit/{{$data->id}}"><span class="glyphicon glyphicon-share"></span> Edit</a></li>
                              <li><a href="#"><span class="glyphicon glyphicon-print"></span> Print the details</a></li>
                              <li class="divider"></li>
                              <li><a href="/subcategories/delete/{{$data->id}}"><span class="glyphicon glyphicon-trash"></span> Remove</a></li>
                           </ul>
                        </div>
                     </div>
                  </td>
