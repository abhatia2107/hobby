    		    ...
    		    <div class="row userInfo">
        			<div class="col-xs-12 col-sm-12">
                        ...
                        <div class="w100 clearfix">
                            <h4>USE</h4>
                            <p>Except as may be explicitly permitted through this site, you agree not to save, download, cut and paste, sell, license, rent, lease, modify, distribute, copy, reproduce, transmit, publicly display, publicly perform, publish, adapt, edit, or create derivative works from materials, code or content on or from hobbyix.com. Systematic retrieval of data or other content from this site to create or compile, directly or indirectly, a collection, compilation, database or directory without written permission from HOBBYIX is prohibited. In addition, use of the content or materials for any purpose not expressly permitted in this Agreement is prohibited.
                            </p>
                            <hr>
                            <h4>SECURITY</h4>
                            <p>You agree that if you are issued a Username and Password by HOBBYIX, you shall use your best efforts to prevent access to this site through your Username and Password by anyone other than yourself, including but not limited to, keeping such information strictly confidential, notifying the HOBBYIX immediately if you discover loss or access to such information by another party not under your control and supervision, and by using a Username and Password not easily guessed by a third party.
                            </p>
                            <p>You agree that you shall not try to reverse engineer, reverse assemble, reverse compile, decompile, disassemble, translate or otherwise alter any executable code, contents or materials on or received via this site. You understand that such actions are likely to subject you to serious civil and criminal legal penalties and that HOBBYIX shall pursue such penalties to the full extent of the law to protect its rights and the rights of its other licensors.
                            </p>
                            <hr>
                            <h4>INTERNATIONAL USERS
                            </h4>
                            <p>Accessing this site, and services, products or contents available on hobbyix.com, except as expressly allowed through instructions and truthful statements by the User in regard to use of this site, from places outside India or where their contents are illegal, is prohibited. Those who choose to access this site from other locations do so knowingly on their own initiative and voluntarily at their own risk and are responsible for compliance with local laws.
                            </p>
                            <hr>
                            <h4>TRADEMARKS
                            </h4>
                            ...
                            <hr>
                            <h4>DISCLAIMER OF WARRANTIES
                            </h4>
                            <p> HOBBYIX AND ITS ADVERTISERS MAKE NO REPRESENTATIONS OR WARRANTIES ABOUT THIS SITE, THE SUITABILITY OF THE INFORMATION CONTAINED ON OR RECEIVED THROUGH USE OF THIS SITE, STABILITY OF WEB SERVER, UP TIME OF WEB SERVER(S) OR ANY SERVICES OR PRODUCTS RECEIVED THROUGH THIS SITE. ALL INFORMATION AND USE OF THIS SITE ARE PROVIDED "AS IS" WITHOUT WARRANTY OF ANY KIND. HOBBYIX AND ADVERTISERS HEREBY DISCLAIM ALL WARRANTIES WITH REGARD TO THIS SITE, THE INFORMATION CONTAINED ON OR RECEIVED THROUGH USE OF THIS SITE AND THE SERVICES RECEIVED THROUGH THIS SITE, INCLUDING ALL EXPESS, STATUTORY, AND IMPLIED WARRANTIES OF MERCHANTABILITY, FITNESS FOR A PARTICULAR PURPOSE, TITLE AND NON-INFRINGEMENT. HOBBYIX AND ADVERTISERS DO NOT WARRANT THAT THE CONTENTS OR ANY INFORMATION RECEIVE THROUGH THIS SITE ARE ACCURATE, RELIABLE OR CORRECT; THAT THIS SITE WEBSITE WILL BE AVAILABLE AT ANY PARTICULAR TIME OR LOCATION; THAT ANY DEFECTS, INCOMPATIBILITIES OR ERRORS WILL BE CORRECTED. YOUR USE OF THIS SITE IS SOLELY AT YOUR RISK. USER AGREES THAT IT HAS RELIED ON NO WARRANTIES, REPRESENTATIONS OR STATEMENTS OTHER THAN IN THIS AGREEMENT. BECAUSE SOME JURISDICTIONS DO NOT PERMIT THE EXCLUSION OF CERTAIN WARRANTIES, THESE EXCLUSIONS MAY NOT APPLY TO YOU BUT SHALL APPLY TO THE MAXIMUM EXTENT PERMITTED BY LAW OF YOUR JURISDICTION.
                            </p>
                            <hr>
                            <h4>LIMITATION OF LIABILITY
                            </h4>
                            <p> UNDER NO CIRCUMSTANCES SHALL HOBBYIX OR ADVERTISERS BE LIABLE FOR ANY DIRECT, INDIRECT, PUNITIVE, INCIDENTAL, SPECIAL, OR CONSEQUENTIAL DAMAGES THAT RESULT FROM, OR ARISE OUT OF THE USE OF, OR INABILITY TO USE, THIS SITE,  THE INFORMATION CONTAINED ON OR RECEIVED THROUGH USE OF THIS SITE, OR ANY SERVICES OR PRODUCTS RECEIVED THROUGH THIS SITE. THIS LIMITATION APPLIES WHETHER THE ALLEGED LIABILITY IS BASED ON CONTRACT, TORT, NEGLIGENCE, STRICT LIABILITY, OR ANY OTHER BASIS, EVEN IF HOBBYIX OR ADVERTISERS HAVE BEEN ADVISED OF THE POSSIBILITY OF SUCH DAMAGE. BECAUSE SOME JURISDICTIONS DO NOT ALLOW THE EXCLUSION OR LIMITATION OF INCIDENTAL OR CONSEQUENTIAL DAMAGES, HOBBYIX AND ADVERTISERS LIABILITY IN SUCH JURISDICTIONS SHALL BE LIMITED TO THE MAXIMUM EXTENT PERMITTED BY LAW OF YOUR JURISDICTION.
                            </p>
                            <hr>
                            <h4>INDEMNIFICATION
                            </h4>
                            <p>You agree to defend, indemnify, and hold harmless HOBBYIX, its advertisers, licensors, subsidiaries and other affiliated companies, and their employees, contractors, officers, agents and directors from all liabilities, claims, and expenses, including attorney's fees, that arise from your use of this site, all services, information or products from this site, or any violation of this Agreement. HOBBYIX reserves the right, at it own expense, to assume the exclusive defense and control of any matter otherwise subject to indemnification by you, in which event you shall cooperate with HOBBYIX in asserting any available defenses.
                            </p>
                            <hr>
                            <h4>LEGAL COMPLIANCE
                            </h4>
                            <p>HOBBYIX may suspend or terminate this Agreement or User’s use immediately upon receipt of any notice which alleges that User has used this site for any purpose that violates any local, state, federal or law of other nations, including but not limited to the posting of information that may violate third party rights, that may defame a third party, that may be obscene or pornographic, that may harass or assault others, that may violate hacking or other criminal regulations, etc. of its agents, officers, directors, contractors or employees. In such event, HOBBYIX may disclose the User’s identity and contact information, if requested by a government or law enforcement body or as a result of a subpoena or other legal action, and HOBBYIX shall not be liable for damages or results thereof and User agrees not to bring any action or claim against HOBBYIX for such disclosure.
                            </p>
                        </div>
				    </div>
			    </div>
