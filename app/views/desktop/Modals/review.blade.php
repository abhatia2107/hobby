...
<div class="modal-dialog" >
    <div class="modal-content">
        <form  onsubmit="return(validateReviewForm())" action='{{secure_url('/comments/store/')}}' method='post' id="reviewForm" enctype="multipart/form-data" method="post" id="commentform" class="comment-form details-container" novalidate="">       
