				...
				<div class="membership_card_container get_membership" style="padding-bottom:15px">
					...
					<div class="row">
						...
						<form method="post" enctype="multipart/form-data" action="/memberships">
							...
							<li class="col-xs-12" @if($referralAmount>0) style="display:block" @else style="display:none" @endif >
								<span class="col-xs-6">Hobbyix Wallet</span><span>: Rs. {{$referralAmount}}/-</span>							
							</li>
